(function () {
  "use strict";
  var CACHE_NAME = "wordywordy-1.0.9";
  var urlsToCache = [
    "./",
    "./index.html",
    "./service-worker.js?0d74d0a46a21f65a",
    "./service-worker.js",
    "./manifest.json",
    "./lib/require.js?0d74d0a46a21f65a",
    "./lib/require.js",
    "./script/wordywordy.js?0d74d0a46a21f65a",
    ...
    "./style/themes/sepia.css?0d74d0a46a21f65a",
    "./style/themes/sepia.css",
    "./style/themes/zany.css",
    "./style/wordywordy.css?0d74d0a46a21f65a",
  ...
  function isSimilarCacheName(pCacheName) {
    return function (pKey) {
      ...
      var lMatch = pKey.match(new RegExp("(" + lCacheRootName + ")-(.+)"));
  ...
  function removeSimilarCaches(pCacheName) {
    caches.keys().then(function (pKeys) {
      pKeys.filter(isSimilarCacheName(pCacheName)).forEach(deleteCache);
    });
  }
